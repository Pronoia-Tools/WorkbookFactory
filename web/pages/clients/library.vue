<template>
  <c-box px="12" py="24">
    <c-flex align="center" px="32" mb="8">
      <svg
        id="Layer_1"
        version="1.1"
    ...
    <!-- search -->
    <c-flex align="center" direction="row-reverse" justify="end" mb="8">
      <c-button left-icon="search" variant-color="blue" variant="solid">
        Search
      </c-button>
      <c-input placeholder="Search" w="25%" mr="3" />
    </c-flex>
      ...
      <c-flex w="50%" p="5%">
        ...
        <c-box>
          <c-text my="6" font-size="18px" font-weight="400"
            >Title:&nbsp;MrAky</c-text
          >
          <c-text my="6" font-size="18px">Author:&nbsp;Mikey</c-text>
          <c-text my="6" font-size="18px">Last opened:&nbsp;06/02/2020</c-text>
          <c-text my="6" font-size="18px">Chapter:&nbsp;5</c-text>
          <c-flex mt="8" align="center">
            <c-text color="blue.400" mr="4">
              <nuxt-link to="/clients/library"> Open eWorkbook </nuxt-link>
            </c-text>
            <svg
              id="Capa_1"
              version="1.1"
  ...
  data() {
    return {
      workbooks: [
        {
          id: 1,
          pathImg: '@/static/default.png',
          title: 'MrAky',
          author: 'Mikey',
          last_opened: '06/02/2020',
          chapter: 5,
        },
        {
          id: 2,
